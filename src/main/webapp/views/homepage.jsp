...
<body oncontextmenu="return false">
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="#about">
			AgastyaNadi Astrology</a></h1>
      </div>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up">
      <h1>Welcome to Parampariya AgastyaNadi Astrology</h1>
      <h2>Seek a solution through Nadi Astrology</h2>
         ...
         <pre>
           ...
           <h2 style= "color:#E5CF72">                                              Guruji Sri SEKAR</h3>   
            ...
            <div class="icon-box" data-aos="fade-up">
             ...
             <pre> <h6> To be found out though thump impression will contain your name, parent's names, Wife, Brother, Sister, 
   present details of profession and gist of future predictions for all the 12 houses.</h6></pre>
            </div>  
            
             <div class="icon-box" data-aos="fade-up">
              <div class="icon"><i class="bx bx-fingerprint"> </i>
              		</div>
              <pre> <h6>Immediate solution for problems like Money, Family, Health, Education, House, Vehicle, Lands, Marriage, Court Cases, Infertility</h6></pre>
            </div> 
            
              <div class="icon-box" data-aos="fade-up">
              <div class="icon"><i class="bx bx-fingerprint"> </i>
              		</div>
              <pre> <h6>Period of Marriage, Reasons for delay in Marriage, Lagnam of Bride of Bridegroom Planetary positions, Future wedded life.</h6></pre>
            </div> 
             <div class="icon-box" data-aos="fade-up">
              <div class="icon"><i class="bx bx-fingerprint"> </i>
              		</div>
              <pre> <h6>Profession, Future Predictions regards to job or Business, Change of Place.</h6></pre>
            </div> 
              <div class="icon-box" data-aos="fade-up">
              <div class="icon"><i class="bx bx-fingerprint"> </i>
              		</div>
              <pre> <h6>Expenditure, Foreign Visit, Next Birth or Attainment of Salvation.</h6></pre>
            </div> 
            <div class="icon-box" data-aos="fade-up">
              <div class="icon"><i class="bx bx-fingerprint"> </i>
              		</div>
              <pre> <h6>SANTHI PARIHARAM: Last Birth, Sins Committed, remedial measures for getting rid of the effect of the past birth's sins.</h6></pre>
            </div> 
             <div class="icon-box" data-aos="fade-up">
              <div class="icon"><i class="bx bx-fingerprint"> </i>
              		</div>
              <pre> <h6>DEEKSHAI KANDAM: Manthra Jepam. Wearing of Rakshai(Talismen) for avoidance of enemies troubles etc.</h6></pre>
            </div>
             <div class="icon-box" data-aos="fade-up">
              <div class="icon"><i class="bx bx-fingerprint"> </i>
              		</div>
              <pre> <h6>AUSHADHA KANDAM: Medicines for long standing disease and methods of taking them.</h6></pre>
            </div> 
             <div class="icon-box" data-aos="fade-up">
              <div class="icon"><i class="bx bx-fingerprint"> </i>
              		</div>
              <pre> <h6>DISABUKTHI KANDAM: (at special rate) Prediction for the runnig Disa Bukthi (Major, Sub Period).</h6></pre>
            </div>   
   ...
   <!--   <section id="faq" class="faq">
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div>
        <!--  <iframe style="border:0; width: 100%; height: 270px;" src="https://maps.google.com/maps?q=rudrappa%20garden%20bangalore&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" allowfullscreen></iframe>-->
        <iframe style="border:0; width: 100%; height: 270px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62406.125444571764!2d77.07261717910156!3d12.154318300000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3baf1f4a255b5025%3A0xf1f92daa82788263!2sBank%20of%20India%20-%20Kollegal%20Branch!5e0!3m2!1sen!2sin!4v1649060579015!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="footer-top">
      ...
      <div class="container">
        ...
        <div class="row  justify-content-center">
          <div class="col-lg-6">
            <h3>Agastya SukshmaNadi</h3>
            <p>Our Centre is to be a leading Astrology centre</p>
          </div>
        </div>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>AgastyaNadi</span></strong>. All Rights Reserved
      </div>
